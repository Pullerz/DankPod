...
class XMCircleGestureRecognizer: UIGestureRecognizer {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent) {
        ...
        if let firstTouch = touches.first {
            ...
            currentPoint = firstTouch.location(in: self.view?.superview!)
    ...
    override func touchesMoved(_ touches: Set<UITouch>, with event: UIEvent) {
        ...
        if let firstTouch = touches.first {
            ...
            currentPoint = firstTouch.location(in: self.view?.superview!)
            previousPoint = firstTouch.previousLocation(in: self.view?.superview!)
...
class CircleGestureRecogniser: UIPanGestureRecognizer {
